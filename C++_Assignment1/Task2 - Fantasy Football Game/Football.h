...
public:
	...
	//ADDED: Returns number of goals conceded.
	int getGoalsCon() const;

	//ADDED: Returns team name.
	string getTeamName(Team* t) const;
...
public:
	...
	//ADDED:Checker for duplicate player entry.
	bool notDuplicatePlayer(Player* p);
